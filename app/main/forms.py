...
class New_photoshoot(FlaskForm):
    ...
    category = SelectField("Photoshoot Category", choices=[('portraits','Portraits'),('wedding','Wedding'),('still life','Still Life'),('family','Family'),('fashion','Fashion'),('something','Something')])
